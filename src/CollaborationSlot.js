...
export default class CollaborationSlot extends Component {
  ...
  renderState0() {
    ...
    return (
      <div className="CollaborationSlot" style={baseStyle}>
        <div className="foreground">
          <div className='baseFont state0_elText' style={style_state0_elText}>
            <div>{this.props.locStrings.empathyslot2_text_177941}</div>
          </div>
      ...
      <div className="CollaborationSlot" style={baseStyle}>
        <div className="foreground">
          ...
          <div className='baseFont state1_elText' style={style_state1_elText}>
            <div><div dangerouslySetInnerHTML={{__html: this.props.locStrings.empathyslot2_text_888129.replace(/\n/g, '<br>')}}></div></div>
          </div>
        </div>
      </div>
    )
