...
import './App.css';
import img_state1_elImage from './images/CuriositySlot_state1_elImage_1010400.jpg';


export default class CuriositySlot extends Component {
  ...
  renderState0() {
    ...
    return (
      <div className="CuriositySlot" style={baseStyle}>
        <div className="foreground">
          <div className='baseFont state0_elText' style={style_state0_elText}>
            <div>{this.props.locStrings.ethicsslot2_text_273580}</div>
          </div>
      ...
      <div className="CuriositySlot" style={baseStyle}>
        <div className="foreground">
          ...
          <div className='baseFont state1_elText' style={style_state1_elText}>
            <div><div dangerouslySetInnerHTML={{__html: this.props.locStrings.ethicsslot2_text_856517.replace(/\n/g, '<br>')}}></div></div>
          </div>
        </div>
      </div>
    )
