...
import './App.css';
import img_state1_elImage from './images/EthicsSlot_state1_elImage_40136.jpg';


export default class EthicsSlot extends Component {
  ...
  renderState0() {
    ...
    return (
      <div className="EthicsSlot" style={baseStyle}>
        <div className="foreground">
          <div className='baseFont state0_elText' style={style_state0_elText}>
            <div>{this.props.locStrings.collaborationslot2_text_627933}</div>
          </div>
      ...
      <div className="EthicsSlot" style={baseStyle}>
        <div className="foreground">
          ...
          <div className='baseFont state1_elText' style={style_state1_elText}>
            <div>{this.props.locStrings.collaborationslot2_text_499924}</div>
          </div>
        </div>
      </div>
    )
