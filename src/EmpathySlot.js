...
import './App.css';
import img_state1_elImage from './images/EmpathySlot_state1_elImage_835231.png';


export default class EmpathySlot extends Component {
  ...
  renderState0() {
    ...
    return (
      <div className="EmpathySlot" style={baseStyle}>
      ...
      <div className="EmpathySlot" style={baseStyle}>
        <div className="foreground">
          ...
          <div className='baseFont state1_elText' style={style_state1_elText}>
            <div>{this.props.locStrings.inventoryitem_text_354864}</div>
          </div>
        </div>
      </div>
    )
