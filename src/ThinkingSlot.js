...
import './App.css';
import img_state1_elImage from './images/ThinkingSlot_state1_elImage_1021962.jpg';


export default class ThinkingSlot extends Component {

  // Properties used by this component:
  // thumb, visualStateIndex
  ...
  renderState0() {
    ...
    return (
      <div className="ThinkingSlot" style={baseStyle}>
        <div className="foreground">
          <div className='baseFont state0_elText' style={style_state0_elText}>
            <div>{this.props.locStrings.curiosityslot2_text_294225}</div>
          </div>
      ...
      <div className="ThinkingSlot" style={baseStyle}>
        <div className="foreground">
          ...
          <div className='baseFont state1_elText' style={style_state1_elText}>
            <div><div dangerouslySetInnerHTML={{__html: this.props.locStrings.curiosityslot2_text_432756.replace(/\n/g, '<br>')}}></div></div>
          </div>
        </div>
      </div>
    )
